...
Height_table_High[1,1]<-"NAM>0.58"
...
Height_table_Moderate[1,1]<-"0.46<=NAM<=0.58"
...
Height_table_Lower[1,1]<-"0.37<=NAM<0.46"
...
Height_table_Lowest[1,1]<-"NAM<0.37"
