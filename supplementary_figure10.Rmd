...
```{r}
####Creating table of correaltion coefficients 
...
#abline(v=seq(-0.6,0.6,by=0.1),col=rgb(0,0,0,0.1))
abline(h=0)
...
#text(x = seq(1, 66, by=1),par("usr")[3] - 0.2,labels=(plot_labels),srt = 45, pos = 1, xpd = TRUE)
...
#points(diamonds$estimated_birth_year,diamonds$NAM, pch=18, col=pcol[11],cex=1.25)
