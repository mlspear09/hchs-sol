...
library(xlsx)
write.table(pheno_results,"/Users/melissaspear/Dropbox/HCHS_SOL/complex_traits/extended_supplementary_table3_new_101920.txt",row.names=F,col.names=T,sep='\t',quote=F)
