---
title: "supp table 3 part 1 edu us born parents"
...
```{r}
fit <- lapply(subset_Mexican_pheno[,9:77], function(x) lm(x ~ AI + birth_year + GENDER + log(WEIGHT_FINAL_NORM_OVERALL) + CENTER + Education + US_BORN + num_us_parents, data = subset_Mexican_pheno,na.action = na.omit))
```
...
library(xlsx)
write.table(pheno_results,"/Users/melissaspear/Dropbox/HCHS_SOL/complex_traits/extended_supplementary_table3_new_101920_edu_us_born_parents.txt",row.names=F,col.names=T,sep='\t',quote=F)
write.xlsx(pheno_results,"/Users/melissaspear/Dropbox/HCHS_SOL/complex_traits/extended_supplementary_table3_new_101920_edu_us_born_parents.xlsx")
```
