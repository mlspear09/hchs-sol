...
axis(side=2,padj=1.5,cex.axis=0.60,cex.lab=0.90)
mtext(side=1,"Birth year",line=1.1)
mtext(side=2,expression(log[10]("Proportion of genome with ROH")),line=1.0,cex.lab=0.8)
...
```{r}
plot(ai_roh_with_pheno_admixture$estimated_birth_year[j4_ai],lw4_ai$fitted[j4_ai],col="#D95F02",lwd=1,lty=3)
```
