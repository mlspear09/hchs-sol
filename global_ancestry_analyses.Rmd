...
```{r}
#plot Figure 1D 
#pdf('/Users/melissaspear/Dropbox/HCHS_SOL/UMAP/overlap_with_ref/plots/HCHS_SOL_with_ref_mixed_other_101819_3PCs_muted_ref_supplementary_figure1b.pdf',height=2.375,width=2.375,pointsize=5)
par(mar=c(2.1,2.1,0.1,0.1))  
#par(mar=c(3,3,1,1))
plot(all_pops$V1,all_pops$V2,pch=0,type='n',xlab="",ylab="",xaxt='n',yaxt='n',bty='n')
legend("topleft",legend=c("CEU","AI","YRI","Mexican","Cuban","Dominican","Central American","Puerto Rican","South American","Mixed/Other"),col=c(set3[9],set3[9],set3[9],pcol[1],pcol[2],pcol[3],pcol[4],pcol[5],pcol[6],pcol[7]),pch=5,cex=0.75,bg='white',bty='n')
...
```{r}
#pdf("/Users/melissaspear/Dropbox/HCHS_SOL/paper_figures/NativeAmerican_ancestry_bootstrap_loess_linear_081319_figure_1D.pdf",height=2.25,width=2.375,pointsize=10)
par(mar=c(2.1,2.1,0.1,0.1))
...
######
#
# Creating table 1 comparing ancestry across the different data stratifications 
#
######
