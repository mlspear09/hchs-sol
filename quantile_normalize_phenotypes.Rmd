...
#rename NAM column 
colnames(subset_Mexican_pheno)[2] <- "AI"
...
library(xlsx)
#write.table(pheno_results,"/Users/melissaspear/Dropbox/hchs-sol_elife-revisions/extended_supplementary_table2.txt",row.names=F,col.names=T,sep='\t',quote=F)
write.xlsx(pheno_results,"/Users/melissaspear/Dropbox/hchs-sol_elife-revisions/extended_supplementary_table3_quantile_normalized.xlsx")
```
