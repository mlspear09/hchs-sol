...
plot(1,1,type='n',xlim=c(1,7),ylim=c(0,0.04),xlab="",ylab="",xaxt='n',yaxt='n')
...
#all samples 
points(ai_total_roh_dataframe$mean,pch=19,type="b",col=mycolors2[11])
polygon(c(ai_total_roh_dataframe$decade_order,rev(ai_total_roh_dataframe$decade_order)),c(ai_total_roh_dataframe$upper_CI,rev(ai_total_roh_dataframe$lower_CI)),col=adjustcolor(mycolors2[11], alpha.f = 0.20), border = NA)
