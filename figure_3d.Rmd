...
pdf("/Users/melissaspear/Dropbox/HCHS_SOL/paper_figures/differnece_in_parental_AI_difference.pdf",height=2.375,width=2.55,pointsize=10)
...
ggplot(mexicans_all,aes(x=Parental_AI_Diff,y=Decade,fill=factor(Decade))) +
  ...
  scale_y_discrete(expand=c(0.2,0)) + scale_fill_manual(values=c("#E41A1C","#FF7F00","#FFFF33","#4DAF4A","#377EB8","#984EA3","#A65628")) + theme(legend.position = "none") + labs(x="Difference in Parental AI ancestry ", y="Decades")
dev.off()
