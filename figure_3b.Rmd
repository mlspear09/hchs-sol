...
legend("bottomleft",legend=c("1930s","1940s","1950s","1960s","1970s","1980s","1990s"),col=c("#E41A1C","#FF7F00","#FFFF33","#4DAF4A","#377EB8","#984EA3","#A65628"),pch=19,cex =0.75,bg="white")
#dev.off()
...
Plot figure with no transparent points
```{r}
require(RColorBrewer)
myColors=brewer.pal(7, "Set1")
...
mtext(side=2,expression(log[10]("Proportion of total ")),line=2.15,cex.lab=0.8)
mtext(side=2,"AI ancestral tracts)",line=1.55,cex.lab=0.8)
points(prop~variable100,data=MX.1930.NAM,pch=16,col=red_trans)
points(prop~variable100,data=MX.1940.NAM,pch=16,col=orange_trans)
points(prop~variable100,data=MX.1950.NAM,pch=16,col=yellow_trans)
points(prop~variable100,data=MX.1960.NAM,pch=16,col=green_trans)
points(prop~variable100,data=MX.1970.NAM,pch=16,col=blue_trans)
points(prop~variable100,data=MX.1980.NAM,pch=16,col=purple_trans)
points(prop~variable100,data=MX.1990.NAM,pch=16,col=brown_trans)
legend("bottomleft",legend=c("1930s","1940s","1950s","1960s","1970s","1980s","1990s"),col=c(red_trans,orange_trans,yellow_trans,green_trans,blue_trans,purple_trans,brown_trans),pch=16,cex=0.75,bg="white")
dev.off()
```
```
