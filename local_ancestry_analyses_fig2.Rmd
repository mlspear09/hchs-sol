...
#pdf("/Users/melissaspear/Dropbox/HCHS_SOL/paper_figures/HCHS_SOL_Mexican_PI_NAM_ancestry_allsamples_decadesback_ALL_072219.pdf",height=2.375,width=2.375,pointsize=10)
par(mar=c(2.1,2.1,0.2,0.1))
plot(1,1,type='n',xlim=c(1,7),ylim=c(0.299,0.304),xlab="",ylab="",xaxt='n',yaxt='n')
axis(side=1,padj=-2,cex.axis=0.7,at=1:7, labels=c("0","1","2","3","4","5","6")) 
axis(side=2,padj=1.5,cex.axis=0.7)
mtext(side=1,"Decades ago",line=1.1)
mtext(side=2,expression(pi),line=1.1)
abline(h=seq(0.299,0.304,by=0.0005),col=rgb(0,0,0,0.1))
legend("bottomright",legend=c("30s","40s","50s","60s","70s","80s","90s"), col=c("#E41A1C","#377EB8","#4DAF4A","#984EA3","#FF7F00","#FFFF33","#A65628"),lty=1,lwd=0.75,bg="white",cex=0.45)
points(means_30s_dataframe,pch=19,type="b",col="#E41A1C")
points(means_40s_dataframe,pch=19,type="b",col="#FF7F00")
points(means_50s_dataframe,pch=19,type="b",col="#FFFF33")
points(means_60s_dataframe,pch=19,type="b",col="#4DAF4A")
points(means_70s_dataframe,pch=19,type="b",col="#377EB8")
points(means_80s_dataframe,pch=19,type="b",col="#984EA3")
points(means_90s_dataframe,pch=19,type="b",col="#A65628")
#dev.off()
...
#############################################################################
##########################################################################################
#One plot thats has all ,sampels gen 0, us-migrant gen 0, migrant migrant 0, us us 0,
...
#> length(us_born_us_born_30s_30s$pi)
#[1] 15
...
####plotting all individuals 
#pdf("/Users/melissaspear/Dropbox/HCHS_SOL/paper_figures/HCHS_SOL_Mexican_PI_NAM_ancestry_migrant_us_born_within_gens_ALL_with_CI_072219_supplementary_figure7.pdf",height=2.25,width=2.375,pointsize=10)
